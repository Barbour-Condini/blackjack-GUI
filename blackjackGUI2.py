...
assets_folder = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'blackjack/assets/'))
...
class GameScreen(Tk):
    def __init__(self):
        ...
        self.CARD_WIDTH_OFFSET = 50

        self.PLAYER_CARD_HEIGHT = 380
        ...
        self.game_screen = Canvas(self, bg="brown", width=800, height=500)

        self.bottom_frame = Frame(self, width=800, height=140, bg="black")
        self.bottom_frame.pack_propagate(0)

        self.hit_button = Button(self.bottom_frame, text="Hit", width=25, command=self.hit)
        self.stick_button = Button(self.bottom_frame, text="Stick", width=25, command=self.stick)

        self.play_again_button = Button(self.bottom_frame, text="Play Again", width=25, command=self.play_again)
        self.quit_button = Button(self.bottom_frame, text="Quit", width=25, command=self.destroy)

        self.hit_button.pack(side=LEFT, padx=(100, 200))
        self.stick_button.pack(side=LEFT)
    ...
    def display_table(self, hide_dealer=True, table_state=None):
        ...
        self.tabletop_image = PhotoImage(file=assets_folder + "/tabletop1.png")
    ...
    def show_play_again_options(self):
        ...
        self.play_again_button.pack(side=LEFT, padx=(100, 200))
